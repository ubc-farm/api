(function (exports,React) {
  ...
  class InteractiveTable extends React.Component {
  	...
  	render() {
  		...
  		columns.push(...buildColumns(cell, data, settings.sort ? sort : undefined, tooltips));
  ...
  function* buildColumns(cell = Cell, data, sortInfo, tooltips = new Map()) {
  	...
  	for (const columnKey in schema) {
  		...
  		let title;
  		if (thisTooltip && 'title' in thisTooltip) title = thisTooltip.title;else title = columnKey;
