...
export default class FeatureCollection extends Array {
	...
	/**
	 * @type {Feature[]} returns the array. Setting a value here will
	 * clear the array then push the values with a spread operator,
	 * meaning an iterator can be used instead of an array.
	 */
