...
import {
	extend, selectiveExtend, randomUUID,
	forEach, convert, equalArray, 
	getAbsoluteTop, getAbsoluteRight, getAbsoluteLeft
} from '../../util.js';
import {asSize} from '../../util-option.js';
 ...
 */
export default class ItemSet extends TimelineComponent {
	/**
